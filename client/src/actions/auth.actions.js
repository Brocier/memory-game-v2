...
// Three possible states for our logout process as well. Since we are using
// JWTs, we just need to remove the token from localStorage. These actions are
// more useful if we were calling the API to log the user out
...
export function loginUser(creds) {
  ...
  return dispatch => {
    ...
    return fetch('http://localhost:4000/sessions/create', config)
